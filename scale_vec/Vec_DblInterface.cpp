...
{
    return ((ScaleSTL_Vec_Dbl*)ScaleSTL_Vec_Dbl_ptr)->element_length(size_t(*index));
}
...
{
    ((ScaleSTL_Vec_Dbl*)ScaleSTL_Vec_Dbl_ptr)->resize(size_t(*newSize));
}

void ScaleSTL_Vec_Dbl_reserve(void * ScaleSTL_Vec_Dbl_ptr,int * maxSize)
{
    ((ScaleSTL_Vec_Dbl*)ScaleSTL_Vec_Dbl_ptr)->reserve(size_t(*maxSize));
}

void ScaleSTL_Vec_Dbl_resize_fill(void * ScaleSTL_Vec_Dbl_ptr,int * newSize,double * fill)
{
    ((ScaleSTL_Vec_Dbl*)ScaleSTL_Vec_Dbl_ptr)->resize(size_t(*newSize),*fill);
}
...
{
    return ((ScaleSTL_Vec_Dbl*)ScaleSTL_Vec_Dbl_ptr)->at(size_t(*index));
}

void ScaleSTL_Vec_Dbl_set(void * ScaleSTL_Vec_Dbl_ptr,int * index,double * value)
{
    ((ScaleSTL_Vec_Dbl*)ScaleSTL_Vec_Dbl_ptr)->set(size_t(*index),*value);
}
...
{
    ((ScaleSTL_Vec_Dbl*)ScaleSTL_Vec_Dbl_ptr)->insert(size_t(*index),*item);
}

void ScaleSTL_Vec_Dbl_erase(void * ScaleSTL_Vec_Dbl_ptr,int * index)
{
    ((ScaleSTL_Vec_Dbl*)ScaleSTL_Vec_Dbl_ptr)->erase(size_t(*index));
}
