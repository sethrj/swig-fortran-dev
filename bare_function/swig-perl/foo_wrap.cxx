...
#define SWIG_init    boot_foomod

#define SWIG_name   "foomodc::boot_foomod"
#define SWIG_prefix "foomodc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_foomod_var::
class _wrap_foomod_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_set_something) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: set_something(x,y);");
    }
...
XS(_wrap_get_something) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: get_something(x);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
{"foomodc::set_something", _wrap_set_something},
{"foomodc::get_something", _wrap_get_something},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
