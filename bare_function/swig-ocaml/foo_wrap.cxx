...
SWIGEXT CAML_VALUE _wrap_set_somethingfoomod (CAML_VALUE args)
{
  CAMLparam1(args);
...
SWIGEXT CAML_VALUE _wrap_get_somethingfoomod (CAML_VALUE args)
{
  CAMLparam1(args);
  SWIG_CAMLlocal2(swig_result,rv);
  int _v = 0;
...
#define SWIG_init f_foomod_init
/* -----------------------------------------------------------------------------
 * Type initialization:
