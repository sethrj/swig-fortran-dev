...
#endif
SWIGINTERN int
_wrap_set_something(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  double arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:set_something x y ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_something" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  ecode2 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "set_something" "', argument " "2"" of type '" "double""'");
  } 
...
SWIGINTERN int
_wrap_get_something(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  double result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:get_something x ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_something" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "set_something", (swig_wrapper_func) _wrap_set_something, NULL},
    { SWIG_prefix "get_something", (swig_wrapper_func) _wrap_get_something, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Foomod_SafeInit(Tcl_Interp *interp) {
