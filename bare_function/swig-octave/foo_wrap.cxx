...
SWIG_DEFUN( set_something, _wrap_set_something, std::string() ) {
  int arg1 ;
  double arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_check_num_args("set_something",args.length(),2,2,0)) {
    SWIG_fail;
  }
...
SWIG_DEFUN( get_something, _wrap_get_something, std::string() ) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  octave_value_list _out;
  ...
  if (!SWIG_check_num_args("get_something",args.length(),1,1,0)) {
    SWIG_fail;
  }
  ecode1 = SWIG_AsVal_int(args(0), &val1);
  if (!SWIG_IsOK(ecode1)) {
...
{"set_something",_wrap_set_something,0,0,2,0},
{"get_something",_wrap_get_something,0,0,2,0},
{0,0,0,0,0}
};
