...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(foomod)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(foomod)
ZEND_DECLARE_MODULE_GLOBALS(foomod)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(foomod_globals_id, zend_foomod_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(foomod_globals_id, zend_foomod_globals *, error_code )
#else
#define SWIG_ErrorMsg() (foomod_globals.error_msg)
#define SWIG_ErrorCode() (foomod_globals.error_code)
#endif
...
static void foomod_init_globals(zend_foomod_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void foomod_destroy_globals(zend_foomod_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_foomod_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_swig_foomod_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_set_something) {
  ...
  /*@SWIG:/Users/s3j/_local/swig-debug/share/swig/3.0.5/php/utils.i,7,CONVERT_INT_IN@*/
  convert_to_long_ex(args[0]);
  arg1 = (int) Z_LVAL_PP(args[0]);
  /*@SWIG@*/;
  
  
  /*@SWIG:/Users/s3j/_local/swig-debug/share/swig/3.0.5/php/utils.i,52,CONVERT_FLOAT_IN@*/
...
/* arginfo subsection */
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_set_something, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_get_something, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
...
static zend_function_entry foomod_functions[] = {
 SWIG_ZEND_NAMED_FE(set_something,_wrap_set_something,swig_arginfo_set_something)
 SWIG_ZEND_NAMED_FE(get_something,_wrap_get_something,swig_arginfo_get_something)
 SWIG_ZEND_NAMED_FE(swig_foomod_alter_newobject,_wrap_swig_foomod_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_foomod_get_newobject,_wrap_swig_foomod_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry foomod_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"foomod",
    foomod_functions,
    PHP_MINIT(foomod),
    PHP_MSHUTDOWN(foomod),
    PHP_RINIT(foomod),
    PHP_RSHUTDOWN(foomod),
    PHP_MINFO(foomod),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &foomod_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &foomod_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(foomod)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(foomod, foomod_init_globals, foomod_destroy_globals);
